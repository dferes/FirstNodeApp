...
function validateNumberArray(arr) {
    numsArr = arr.map( num => Number(num));
    return numsArr.includes(NaN) ? new Error('Only include numbers in the query string') : false;
}


module.exports = {getMean, getMode, getMedian, validateNumberArray};